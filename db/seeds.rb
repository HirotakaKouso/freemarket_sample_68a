...
Prefecture.create( prefecture: '青森県' )
Prefecture.create( prefecture: '岩手県' )
Prefecture.create( prefecture: '宮城県' )
Prefecture.create( prefecture: '秋田県' )
Prefecture.create( prefecture: '山形県' )
Prefecture.create( prefecture: '福島県' )
Prefecture.create( prefecture: '茨城県' )
Prefecture.create( prefecture: '栃木県' )
Prefecture.create( prefecture: '群馬県' )
Prefecture.create( prefecture: '埼玉県' )
Prefecture.create( prefecture: '千葉県' )
Prefecture.create( prefecture: '東京都' )
Prefecture.create( prefecture: '神奈川県' )
Prefecture.create( prefecture: '山梨県' )
Prefecture.create( prefecture: '長野県' )
Prefecture.create( prefecture: '新潟県' )
Prefecture.create( prefecture: '富山県' )
Prefecture.create( prefecture: '石川県' )
Prefecture.create( prefecture: '福井県' )
Prefecture.create( prefecture: '岐阜県' )
Prefecture.create( prefecture: '静岡県' )
Prefecture.create( prefecture: '愛知県' )
Prefecture.create( prefecture: '三重県' )
Prefecture.create( prefecture: '滋賀県' )
Prefecture.create( prefecture: '京都府' )
Prefecture.create( prefecture: '大阪府' )
Prefecture.create( prefecture: '兵庫県' )
Prefecture.create( prefecture: '奈良県' )
Prefecture.create( prefecture: '和歌山県' )
Prefecture.create( prefecture: '鳥取県' )
Prefecture.create( prefecture: '島根県' )
Prefecture.create( prefecture: '岡山県' )
Prefecture.create( prefecture: '広島県' )
Prefecture.create( prefecture: '山口県' )
Prefecture.create( prefecture: '徳島県' )
Prefecture.create( prefecture: '香川県' )
Prefecture.create( prefecture: '愛媛県' )
Prefecture.create( prefecture: '高知県' )
Prefecture.create( prefecture: '福岡県' )
Prefecture.create( prefecture: '佐賀県' )
Prefecture.create( prefecture: '長崎県' )
Prefecture.create( prefecture: '熊本県' )
Prefecture.create( prefecture: '大分県' )
Prefecture.create( prefecture: '宮崎県' )
Prefecture.create( prefecture: '鹿児島県' )
Prefecture.create( prefecture: '沖縄県' )
